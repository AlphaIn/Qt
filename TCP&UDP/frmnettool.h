...
private slots:
    ...
    void sendDataUdpClient();
    void sendDataUdpClient(QString data);

    void appendTcpClient(quint8 type, QString msg);
    void appendUdpClient(quint8 type, QString msg);
...
private slots:
    ...
    void udpClientReadData();
    void udpClientReadError();
    ...
    void clientUdpReadData(int, QString ip, int port, QByteArray data);
    void clientUdpConnect(int, QString ip, int port);
    void clientUdpDisConnect(int, QString ip, int port);
...
private slots:
    ...
    void on_btnUdpConnect_clicked();
    void on_btnClearUdpClient_clicked();
};
